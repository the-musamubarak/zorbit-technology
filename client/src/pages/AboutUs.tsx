...
export default function AboutUs() {
  return <div className="about-page">
    <header className="subpage-header"><a className="brand" href="/"><img className="brand-mark" src="/images/logo-mark.png" alt="Zorbit Technology logo" /><span><b>ZORBIT</b><small>TECHNOLOGY</small></span></a><nav className="subpage-nav"><a href="/">Home</a><a href="/#services">Services</a><a href="/#work">Portfolio</a><a href="/about" aria-current="page">About Us</a><a className="nav-cta" href="/founder">Meet the founder <ArrowUpRight size={15} /></a><a className="nav-cta" href="/#contact">Contact <ArrowUpRight size={15} /></a></nav></header>
    <main>
