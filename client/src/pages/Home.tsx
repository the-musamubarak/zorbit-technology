...
export default function Home() {
  ...
  return <div className="zorbit-page">
    ...
    <main>
      ...
      <section id="about" className="about-section section-shell"><div className="about-statement"><span className="section-index">04 / ABOUT ZORBIT</span><h2>Useful technology<br /><span>starts with listening.</span></h2><div className="about-profile"><div className="profile-role">COMPANY / OPERATING PRINCIPLE</div><h3>Clarity is<br />the product.</h3><p className="profile-specialism">Data · Digital products · Useful systems</p></div><p>Zorbit is a Nigerian technology company for organisations and individuals who need better visibility, stronger digital experiences, and more useful systems. We combine data, design, and delivery to help clients move from scattered inputs to practical next steps.</p><p>Our work begins with the operating point: the decision to improve, the process to simplify, the audience to reach, or the opportunity to make usable. From there, we build with evidence, clarity, and a focus on what will keep working after launch.</p><div className="about-signals"><span>DATA &amp; INSIGHT</span><span>WEBSITES &amp; SOFTWARE</span><span>RESEARCH &amp; DELIVERY</span></div><div className="about-links"><a className="text-link" href="/about">About Zorbit <ArrowUpRight size={16} /></a><a className="text-link text-link-muted" href="/founder">Meet the founder <ArrowUpRight size={16} /></a></div></div><div className="credential-card"><div className="credential-head"><ShieldCheck size={20} /><span>COMPANY / PROFILE</span></div><div className="credential-big">Built in<br /><strong>Abuja.</strong></div><dl><div><dt>Status</dt><dd>CAC Registered Business</dd></div><div><dt>Founded</dt><dd>2024</dd></div><div><dt>Focus</dt><dd>Data · Digital · Intelligence</dd></div><div><dt>Reach</dt><dd>Nigeria + Remote</dd></div></dl><div className="credential-seal"><Check size={15} /> VERIFIED OPERATOR</div></div></section>
