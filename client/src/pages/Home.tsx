...
export default function Home() {
  ...
  return <div className="zorbit-page">
    ...
    <main>
      ...
      <section className="brand-banner" aria-label="Zorbit Technology capabilities"><div className="brand-banner-mark"><img src="/manus-storage/zorbit-mark_5e4a6e4a.png" alt="" /></div><div className="brand-banner-name"><span>THE ZORBIT SIGNAL</span><strong>Zorbit Technology</strong></div><p>Data analytics <i /> Digital products <i /> Research intelligence <i /> Tech consulting &amp; training</p><a href="#services" aria-label="Explore Zorbit services"><ArrowUpRight size={21} /></a></section>
