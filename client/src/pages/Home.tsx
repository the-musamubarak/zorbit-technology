...
const projects = [
  { number: "01", title: "Writers Support Services", tools: ["Website build", "Resource store", "Workshop flow"], text: "A polished multi-page academic-services website with clear service discovery, a resource store, and workshop pathways for researchers and institutions.", href: "https://writerssupportservices.com/", linkLabel: "Visit live website" },
  { number: "02", title: "Inventory & Debt Tracking Software", tools: ["Inventory control", "Debt tracking", "Business reporting"], text: "Custom business software built to help a client track stock, sales activity, outstanding debts, and day-to-day operational records in one place." },
  { number: "03", title: "NITDA Digital File Tracking Dashboard", tools: ["Power BI", "DAX", "Python"], text: "A visibility layer for tracking digital files, bottlenecks, and operational throughput." },
  { number: "04", title: "Nigerian Road Traffic Crashes Dashboard", tools: ["Power BI", "NBS/FRSC data", "Visual reporting"], text: "A public-data lens that makes crash patterns easier to read, compare, and act on." },
  { number: "05", title: "TopUp Hub VTU Application", tools: ["React", "Supabase", "Paystack"], text: "A dependable mobile-first experience for everyday digital top-ups and payments." },
];
