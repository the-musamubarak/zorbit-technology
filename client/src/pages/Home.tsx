...
const dashboardShowcase = [
  { number: "01", title: "Insurance Dashboard", caption: "An operating view for reading insurance performance and portfolio activity in one place.", image: "/manus-storage/insurance-dashboard_1efc6c96.png", href: "https://app.powerbi.com/view?r=eyJrIjoiYzQ0YjdkZTgtMjExNi00MjU0LTk0YzYtMmM2MDhmYmU1ZGM0IiwidCI6ImJiODFhNDdjLTJiMzMtNGVkOC05NGZlLTgwM2YwYmJiZjE0OSJ9&embedImagePlaceholder=true&pageName=732b15e505165348cb75" },
  { number: "02", title: "NITDA Dashboard", caption: "A clearer data view for monitoring digital-file activity, operational movement, and programme visibility.", image: "/manus-storage/nitda-dashboard_726ea4af.png", href: "https://app.powerbi.com/view?r=eyJrIjoiYzQ3MTAyODMtY2NjNC00YjBmLWFiNDAtZjhmMmQzODYxNTFlIiwidCI6ImJiODFhNDdjLTJiMzMtNGVkOC05NGZlLTgwM2YwYmJiZjE0OSJ9" },
  { number: "03", title: "UK Accident Dashboard", caption: "A decision view that surfaces road-incident patterns, trends, and priority signals for faster interpretation.", image: "/manus-storage/uk-accident-dashboard_62038ca2.png", href: "https://app.powerbi.com/view?r=eyJrIjoiMDU3MDAxOGItYjg1MS00NDQ5LTkyNGYtMGRkM2U0MThhOWFhIiwidCI6ImJiODFhNDdjLTJiMzMtNGVkOC05NGZlLTgwM2YwYmJiZjE0OSJ9" },
  { number: "04", title: "Supermarket Dashboard", caption: "A compact commercial view of sales movement, category performance, and day-to-day retail activity.", image: "/manus-storage/supermarket-dashboard_1d45ef67.png", href: "https://app.powerbi.com/view?r=eyJrIjoiMmI2OTgxZDAtNmVkMi00YTNmLTk3MWMtNjgwZTRlYjM3MWI2IiwidCI6ImJiODFhNDdjLTJiMzMtNGVkOC05NGZlLTgwM2YwYmJiZjE0OSJ9" },
  { number: "05", title: "Fitness Dashboard", caption: "A visual evidence board for tracking fitness and performance indicators in a usable reporting format.", image: "/manus-storage/fitness-dashboard_57039e84.png", href: "https://app.powerbi.com/view?r=eyJrIjoiZDc2ZTg3ZmYtYTMyYi00ODkxLTgxMzgtNGIyODAwOGVmOWJlIiwidCI6ImJiODFhNDdjLTJiMzMtNGVkOC05NGZlLTgwM2YwYmJiZjE0OSJ9" },
];
